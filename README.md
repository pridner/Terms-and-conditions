...
By providing my phone number, I consent to receive SMS text messages from PMM Restoration, LLC  for appointment reminders, marketing messages, and general two-way communication related to PMM Restoration, LLC. Message and Data Rates may apply. 

Message Frequency 
You will get more than one message from us unless you opt-out, and while messaging frequency varies. PMM Restoration, LLC  reserves the right to alter the frequency of messages at any time to increase or decrease the total number of messages. PMM Restoration, LLC  and carriers are not liable for delays or undelivered messages. 

<p>By opting in to receive SMS messages from <strong>SERVPRO of Coffee, Franklin, Warren</strong>, you agree to receive conversational messages related to your interactions with us.
  Message type: conversational messages
  Message frequency: Message frequency may vary. On average, 1-2 messages per month.
  Consent:</strong> By providing your mobile number and opting in, you consent to receive conversational messages from PMM Restoration, LLC .
  Opt out:Reply STOP to unsubscribe at any time.
  Help:</strong> Reply HELP for assistance.
  Privacy policy:</strong> https://github.com/pridner/messaging-privacy-policy/blob/main/README.md
...
By providing your mobile number and opting in, you confirm that you are authorized to receive SMS messages from PMM Restoration, LLC, at that number.
